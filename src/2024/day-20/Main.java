...
class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// precompute shortest path to every empty cell
		dp = new long[grid.length][grid[0].length];
		bfs(grid);

		// part 1
		long part1 = solve(grid, 2);
		System.out.println(part1);

		// part 2
		long part2 = solve(grid, 20);
		System.out.println(part2);

		io.close();
	}

	static long solve(char[][] grid, int maxCheat) {
